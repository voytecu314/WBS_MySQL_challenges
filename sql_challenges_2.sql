...
SELECT pub_name AS name, city FROM publishers WHERE country='Germany' OR country='France';
...
SELECT au_fname AS name, au_lname AS last_name, city
FROM authors 
WHERE au_fname='Dean' AND (city='Oakland' OR city='Barkley'); 
...
WHERE (city='Oakland' OR city='Berkley') AND NOT au_lname='Straight';